...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Last Time Index:"
        '
        'Label3
        '
        ...
        Me.Label4.Text = "Press numpad 1 to update start time."
        '
        'Label5
        '
        ...
        Me.Label5.Text = "Press numpad 0 to index, files saved to same directory."
        '
        'Form1
        '
        ...
        Me.Name = "Form1"
        Me.Text = "Time Stamper by Pillazo!"
